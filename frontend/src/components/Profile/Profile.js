...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "http://localhost:3001/api/v1/users/" + sessionStorage.getItem("token")
      )
      .then((response) => {
    ...
    // axios.get("http://localhost:3001/api/v1/items/").then((response) => {
          ...
          <CRow>
            ...
            <CCol>
              ...
              {hasShop ? (
                ...
                <Link to="/createshop" className="btn btn-primary">
                  Create Shop
                </Link>
              )}
            </CCol>
